...
provider strings, model configuration, and harness-specific support notes.
...
This runtime-built agent enables the core harness pieces:
...
Use [Tracing](tracing.md) to emit local traces or export runs to LangSmith.
