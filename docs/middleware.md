...
Add middleware to module-defined agents with `middleware/1`:
...
defmodule MyApp.SupportAgent do
  ...
  middleware [
    {Middleware.DynamicPrompt, prompt: &__MODULE__.system_prompt/1},
    {Middleware.ModelRetry, max_retries: 2, initial_delay: 25},
...
The Python middleware overview links to LangSmith agent testing. BeamWeaver's
...
boundaries; there is no BeamWeaver-specific LangSmith test runner.
{% endhint %}
