...
defmodule MyApp.ReviewedAgent do
  ...
  tools [MyApp.Tools.RemoveFile, MyApp.Tools.FetchFile, MyApp.Tools.NotifyEmail]
...
| LangSmith Studio static interrupt UI and hosted debugging. | Not implemented as a BeamWeaver product surface. Use checkpoint state APIs, stream events, tracing, and application tooling. |
