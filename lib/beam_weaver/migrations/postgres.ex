defmodule BeamWeaver.Migrations.Postgres do
  ...
  defp module_base(:langsmith_queue), do: BeamWeaver.Migrations.Postgres.LangSmithQueue
  ...
  defp normalize_spec(:langsmith_queue = key, opts) do
    adapter_opts = [table: Keyword.get(opts, :table, "beam_weaver_langsmith_queue")]
    spec(key, Keyword.fetch!(adapter_opts, :table), adapter_opts)
  end
