defmodule BeamWeaver.Graph do
  ...
  @doc "Declares a barrier join. The downstream node runs after all upstream nodes complete."
  @spec add_join(StateGraph.t(), [node_name()], node_name(), keyword()) :: StateGraph.t()
  defdelegate add_join(graph, upstream_nodes, downstream_node, opts \\ []), to: StateGraph
