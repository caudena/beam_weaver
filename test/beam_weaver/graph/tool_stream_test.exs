defmodule BeamWeaver.Graph.ToolStreamTest do
  ...
  # - langgraph/libs/langgraph/tests/test_tool_stream_handler.py::test_emit_output_delta_produces_delta_events
  # - langgraph/libs/langgraph/tests/test_tool_stream_handler.py::test_parallel_tool_calls_do_not_bleed
  # - langgraph/libs/langgraph/tests/test_tool_stream_handler.py::test_tool_error_event
  # - langgraph/libs/langgraph/tests/test_tool_stream_handler.py::test_no_events_without_tools_mode
  # - langgraph/libs/langgraph/tests/test_tool_stream_handler.py::test_tool_inside_subgraph_emits_with_subgraph_ns
