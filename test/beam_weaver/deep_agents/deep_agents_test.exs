...
defmodule BeamWeaver.AgentCapabilitiesTest do
  ...
  test "task subagent forwards non-private parent state and returns merge command" do
    ...
    assert metadata.lc_agent_type == "subagent"
  ...
  test "subagent middleware validates specs and accepts string-key maps" do
    assert_raise ArgumentError, ~r/at least one subagent/, fn ->
    ...
    assert Tool.description(task_tool) =~ "json-worker: String-key worker"
  end
