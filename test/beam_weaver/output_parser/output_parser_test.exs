defmodule BeamWeaver.OutputParserTest do
  ...
  # Upstream references:
  # - langchain/libs/core/tests/unit_tests/output_parsers/test_json.py
  # - langchain/libs/core/tests/unit_tests/output_parsers/test_list_parser.py
  # - langchain/libs/core/tests/unit_tests/output_parsers/test_openai_tools.py
  # - langchain/libs/core/tests/unit_tests/output_parsers/test_openai_functions.py
  ...
  test "string parser transforms text and message streams chunk by chunk" do
    # Upstream references:
    # - langchain/libs/core/langchain_core/output_parsers/string.py
  ...
  test "json utility facade parses markdown partial JSON and checks required keys" do
    # Upstream reference:
    # langchain/libs/core/langchain_core/utils/json.py
    assert {:ok, %{"name" => "Ada"}} =
  ...
  test "xml parser handles attributes self-closing nodes and rejects entity payloads" do
    # Upstream reference:
    # langchain/libs/core/tests/unit_tests/output_parsers/test_xml_parser.py
    assert {:ok,
            %{
              name: "root",
              attributes: %{"id" => "r1"},
  ...
  test "parse_result uses the first generation-like value and parser specs round-trip" do
    # Upstream reference:
    # langchain/libs/core/tests/unit_tests/output_parsers/test_base_parsers.py
    assert {:ok, "first"} =
