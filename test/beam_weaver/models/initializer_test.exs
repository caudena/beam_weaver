defmodule BeamWeaver.Models.InitializerTest do
  ...
  test "OpenAI tokenizer adapter gives exact deterministic counts when explicitly supplied" do
    # Upstream reference:
    # langchain/libs/core/tests/unit_tests/language_models/chat_models/test_base.py
  ...
  test "OpenAI tokenizer matches upstream multilingual token-count fixtures" do
    # Upstream reference:
    # langchain/libs/partners/openai/tests/unit_tests/test_token_counts.py
    text = "表情符号是\n🦜🔗"
  ...
  test "profile preserves unknown keys without creating runtime atoms" do
    # Upstream reference:
    # langchain/libs/core/tests/unit_tests/language_models/test_model_profile.py
