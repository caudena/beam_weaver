defmodule BeamWeaver.OpenAI.ResponsesTest do
  ...
  test "explicit Responses model preserves ChatModel behavior and request options" do
    # Upstream reference:
    # langchain/libs/partners/openai tests for Responses request option forwarding.
  ...
  test "Responses prompt_cache_key follows upstream inclusion and per-call precedence" do
    # Upstream reference:
    # langchain/libs/partners/openai/tests/unit_tests/chat_models/test_prompt_cache_key.py
