defmodule BeamWeaver.TextSplitterTest do
  ...
  # Upstream references:
  # - langchain_text_splitters/tests/unit_tests/test_text_splitters.py
  # - langchain_text_splitters/tests/unit_tests/test_html_header_text_splitter.py
  ...
  test "character splitter matches upstream word-boundary overlap behavior" do
    # Translates langchain_text_splitters test_text_splitters.py::test_character_text_splitter
  ...
  test "recursive JSON splitter keeps nested JSON fragments bounded" do
    # Translates recursive JSON splitter behavior from langchain_text_splitters.
