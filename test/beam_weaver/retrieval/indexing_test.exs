defmodule BeamWeaver.IndexingTest do
  ...
  # Upstream references:
  # - langchain_core indexing API tests for idempotent indexing and cleanup modes
  ...
  test "documents can be copied with deterministic hash ids" do
    # Upstream reference:
    # langchain/libs/core/tests/unit_tests/indexing/test_hashed_document.py
  ...
  test "incremental cleanup handles same-source deletion without touching other sources" do
    # Translates langchain_core indexing/test_indexing.py::test_incremental_delete_with_same_source.
    store = VectorETS.new(embedding: %FakeEmbeddingModel{})
    records = RecordETS.new()
  ...
  test "record manager facade covers standard update exists list delete and async helpers" do
    # Upstream reference:
    # langchain/libs/core/langchain_core/indexing/base.py
  ...
  test "memory document index supports standard upsert get delete retrieve and async helpers" do
    # Upstream references:
    # - langchain/libs/core/langchain_core/indexing/in_memory.py
    # - langchain/libs/standard-tests/langchain_tests/integration_tests/indexer.py
  ...
  test "memory document index retrieves ranked documents through sync and async retriever facade" do
    # Upstream reference:
    # langchain/libs/core/tests/unit_tests/indexing/test_in_memory_indexer.py
