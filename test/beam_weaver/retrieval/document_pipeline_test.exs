defmodule BeamWeaver.DocumentPipelineTest do
  ...
  # Upstream references:
  # - langchain_core document loader lazy-load tests
  # - langchain_core document transformer/compressor behavior
  # - langchain_core indexing API tests for partial failures and cleanup
  # - langchain_core example selector MMR behavior
  ...
  test "JSON-lines parser returns tagged errors for malformed lines" do
    # Upstream reference:
    # langchain_core document loader/parser tests: malformed source rows fail as parser
  ...
  test "JSON parser custom string keys do not create atoms and preserve metadata" do
    # Upstream reference:
    # langchain_core loader/parser schema-key tests, translated to BeamWeaver's
